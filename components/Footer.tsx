...
export default function Footer() {
    ...
    return (
        <footer id="contact" ref={footerRef} className="bg-[#1c1c2b] text-gray-400 min-h-[auto] lg:min-h-dvh py-8 min-[720px]:py-12 lg:py-16 relative z-30 overflow-hidden font-sans flex flex-col justify-center">
            {/* Decorative Separator */}
            <div className="absolute top-0 left-0 w-full flex justify-center pt-6 md:pt-16">
            ...
            <div ref={contentRef} className="container mx-auto px-4 md:px-12 opacity-0 py-4 lg:py-0">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-center h-full">
                    ...
                    <div className="flex flex-col gap-6 md:gap-12 order-2 lg:order-1 text-center lg:text-left">
                        {/* Heading */}
                    ...
                    <div className="bg-[#161622] p-4 sm:p-6 md:p-10 rounded-3xl border border-gray-800/50 shadow-2xl relative overflow-hidden order-1 lg:order-2">
                        {/* Status Overlay */}
                        {formStatus === "success" && (
                        ...
                        <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col gap-4 relative z-10">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <input
                                    ...
                                    className="bg-[#1c1c2b] border border-gray-700 rounded-xl px-4 py-2 text-white text-sm focus:outline-none focus:border-gray-500 transition-colors placeholder:text-gray-600"
                                />
                            </div>
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <textarea
                                    ...
                                    className="bg-[#1c1c2b] border border-gray-700 rounded-xl px-4 py-2 text-white text-sm focus:outline-none focus:border-gray-500 transition-colors placeholder:text-gray-600 resize-none"
                                ></textarea>
                            </div>
                            ...
                            <button
                                ...
                                className="mt-1 bg-white text-black font-bold py-2.5 px-6 rounded-full hover:bg-gray-200 transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed group text-sm"
                            >
                                {formStatus === "submitting" ? "Sending..." : "Send Message"}
                                {!formStatus.startsWith("submit") && <FiSend className="w-3 h-3 transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" />}
                            </button>
                        </form>
                    </div>
